...
base_path = config.Train.BASE_PATH

train_path = config.Train.TRAIN_PATH  # Training data (annotation file)

num_rois = config.Train.NUM_ROIS  # Number of RoIs to process at once.
